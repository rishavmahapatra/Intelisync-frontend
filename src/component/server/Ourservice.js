...
//         {/* Background Blur */}
//         <div
//           className="absolute w-[200px] h-[500px] blur-[100px] top-[-50px] right-25 rotate-[148.52deg] 
...
//               Empowering your business with innovative Blockchain, Web3, and AI
  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto">
      <section className="bg-[#000B18] overflow-x-hidden text-white flex flex-col items-center justify-center py-8 lg:py-16 px-5 md:px-10 lg:px-20 xl:px-32 relative">
        ...
        {/* Background Blur */}
        <div className="absolute w-[200px] h-[500px] blur-[100px] top-[-50px] right-25 rotate-[148.52deg] bg-[linear-gradient(256.74deg,rgba(4,158,188,0.5)_47.38%,rgba(0,55,90,0.5)_61.04%,rgba(73,0,116,0.5)_70.05%)]"></div>

        {/* Services Title */}
        <div className="relative flex flex-col items-center justify-center text-center mb-10 w-full max-w-screen-xl mx-auto">
          <h2 className="absolute top-5 sm:top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[3rem] sm:text-[5rem] md:text-[7rem] lg:text-[10rem] xl:text-[13rem] font-semibold uppercase tracking-wide text-transparent outline-text opacity-5 z-0">
            SERVICES
          </h2>
...
>>>>>>> d07745cd2b1dd3687ceb56c42dea1b0470603c02
}
