...
export default function Footer() {
  return (
    ...
    >
      <div
        className="absolute inset-0 top-13 border-t-2 sm:border-t-3 md:border-t-4 border-teal-600 
      ...
      <div className="p-10 lg:w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          ...
          <p className="mt-4 text-sm text-gray-400 ">
            ...
            <p>
              ...
              specializing in secure dApps, DeFi, RWA tokenization, and
              AI-driven solutions. We offer end-to-end services, including smart
              contracts, Layer 2 scaling, DEX/CEX development, and token
              launches. Our Web3 marketing expertise covers influencer
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {/* First row */}
            <a
              href="https://www.linkedin.com/company/intelisync"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gray-700 p-2 rounded-full hover:scale-110 transition"
            >
              <FaLinkedinIn className="text-lg text-[rgb(61,232,232)]" />
            </a>
            <a
              href="https://x.com/Intelisync_"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gray-700 p-2 rounded-full hover:scale-110 transition"
            >
            ...
            <a
              href="https://www.instagram.com/intelisync.ai"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gray-700 p-2 rounded-full hover:scale-110 transition"
            >
            ...
            <a
              href="https://chat.whatsapp.com/ETtg5JskhZ884wDqE1oD7G"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gray-700 p-2 rounded-full hover:scale-110 transition"
            >
            ...
            <div className="flex flex-wrap gap-2 w-full justify-start">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-700 p-2 rounded-full hover:scale-110 transition cursor-pointer"
              >
                <FaFacebookF className="text-lg text-[rgb(61,232,232)]" />
              </a>
              <a
                href="https://www.youtube.com/@intelisync"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-700 p-2 rounded-full hover:scale-110 transition"
              >
              ...
              <a
                href="https://medium.com/@Intelisync"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-700 p-2 rounded-full hover:scale-110 transition"
              >
              ...
              <a
                href="https://www.quora.com/profile/Intelisync"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-700 p-2 rounded-full hover:scale-110 transition"
              >
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-400 text-sm mr-10">
            {[
              {
                name: "Dubai - UAE | Intelisync",
                link: "/global-presence/dubai",
              },
              {
                name: "Singapore | Intelisync Pvt Ltd",
                link: "/global-presence/singapore",
              },
              ...
              {
                name: "India - Pune | Intelisync Technology Pvt Ltd",
