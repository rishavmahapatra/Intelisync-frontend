      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 ">
        ...
        <div className="space-y-12">
          <div className="flex items-center space-x-5">
            ...
            <p className="font-poppins">Boost website traffic and enhance lead conversion.</p>
          </div>
          <div className="flex items-center space-x-5">
            <Image src="/photos/expert2.png" alt="Expert 2" width={40} height={40} />
            <p className="font-poppins">Build trust and establish authority in your industry.</p>
          </div>
          <div className="flex items-center space-x-5">
            <Image src="/photos/expert3.png" alt="Expert 3" width={40} height={40} />
            <p className="font-poppins">Increase revenue and maximize business profitability.</p>
          </div>
        </div>

        {/* Right Column */}
        <div className="space-y-16 mt-2">
          <p className="font-poppins">Strengthen your online presence and grow customer engagement.</p>
          <p className="font-poppins">Optimize digital strategies to accelerate sustainable growth.</p>
        </div>
      </div>
    </section>
  );
