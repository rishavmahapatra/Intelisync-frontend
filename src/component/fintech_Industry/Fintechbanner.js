...
export default function Banner() {
    return (
        <div className="relative flex items-center justify-start h-[80vh] text-white overflow-hidden px-10 md:px-20">
            {/* Background Image */}
            <div
            ...
            <div className="relative text-left max-w-3xl z-10">
                <h1 className="font-poppins font-semibold text-[38px] md:text-[42px] leading-[50px] md:leading-[55px] tracking-[-0.01em]">
                    Leading Marketing Agency for Fintech and Financial Technology
                </h1>
