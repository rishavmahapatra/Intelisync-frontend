  ...
  return (
    <div className="bg-[#020B17] text-white py-16 px-6 md:px-20 lg:px-32 flex flex-col md:flex-row justify-center items-center min-h-screen gap-6 md:gap-10">
      ...
      <div className="max-w-2xl w-full text-center md:text-left">
        ...
        <p className="font-poppins font-semibold text-[24px] sm:text-[30px] bg-gradient-to-r from-cyan-500 to-teal-500 bg-clip-text text-transparent mx-auto md:mx-0 w-[85%] md:w-[75%]">
