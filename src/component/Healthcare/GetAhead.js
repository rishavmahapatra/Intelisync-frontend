...
export default function GetAhead() {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center bg-[#020B17] text-white px-6 lg:px-32 items-center min-h-screen py-10 gap-10">
      {/* Image Section */}
      <div className="flex flex-col lg:flex-row items-center gap-6 text-center lg:text-left w-full">
        ...
        <div className="max-w-4xl w-full">
          <h1 className="font-poppins font-medium text-[28px] sm:text-[35px] leading-[40px] sm:leading-[50px] tracking-[-0.01px]">
          ...
          {content.map((paragraph, index) => (
            <p key={index} className="font-poppins font-normal text-[15px] sm:text-[16px] leading-[28px] sm:leading-[30px] tracking-[-0.05px] text-gray-300 mt-4 sm:mt-6">
              {paragraph}
            </p>
          ))}
        </div>
