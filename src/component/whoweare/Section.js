        ...
        <div className="relative">
            ...
            <section className="relative overflow-hidden text-white min-h-[600px] py-12 px-4 sm:px-6 lg:px-20 bg-[#000B18]">
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between ">
                    {/* Background Gradient */}
                    <div className="absolute w-[150px] h-[150px] blur-[100px] top-10 left-5 sm:w-[200px] sm:h-[200px] sm:top-30 sm:left-10 rotate-[148.52deg] 
                    ...
                    <div className="max-w-2xl z-10 text-center lg:text-left">
                        ...
                        <div className="mb-6 flex justify-center lg:justify-start">
                            <button className="flex items-center gap-3 px-6 sm:px-8 py-2 rounded-full bg-gradient-to-r from-[rgba(3,190,223,0.75)] to-[rgba(6,255,240,0.75)] opacity-90 text-white text-lg 
                        ...
                        <p className="mt-3 text-sm sm:text-md text-gray-200">
                            From crypto project marketing to ICO promotions, Intelisync assists brands looking for trusted associations within Web3, fostering long-lasting trust. We&apos;re happy to help you scale and create an impact in the blockchain world.
                        </p>
                    </div>
