    ...
    return (
        <div className="relative flex items-center justify-center md:justify-start w-full h-screen text-white bg-[#000B18] z-10 ">
            ...
            <div className="w-[82%] mx-auto text-left">
                ...
                Riyadh is emerging as a global hub for Web3, AI-driven gaming, and blockchain innovation, fueled by Saudi Arabia&pose;s Vision 2030. Intelisync is at the forefront, empowering businesses with transformative digital solutions that drive growth and innovation.               
                </p>
