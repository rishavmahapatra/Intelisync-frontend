...
import first from "@/components/landingpage/photos/event1.png";
import second from "@/components/landingpage/photos/event2.png";
import third from "@/components/landingpage/photos/event3.png";
import fourth from "@/components/landingpage/photos/event4.png";
...
className="flex flex-col items-center justify-center max-w-screen-xl mx-auto p-12 py-10"
    ...
    >
      ...
      <button className=" mb-20 px-6 py-2 text-white text-lg font-semibold rounded-full
               bg-gradient-to-r from-cyan-500 to-teal-500 shadow-lg
                transition-all duration-300 mt-[-10px]">
